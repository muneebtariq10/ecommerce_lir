        ...
        <AdminAuthenticated
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Brand "{brand.name}"</h2>
                </div>
            }
        >
            <Head title="Brands" />
                        ...
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            {brand.image && (
                                <div className="flex justify-center items-center mb-4">
                                    <img src={brand.image} className="w-64" />
                                </div>
                            )}
